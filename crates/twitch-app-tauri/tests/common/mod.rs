...
//!
//! Mirrors the helpers in `src/test_helpers.rs` so integration tests can use
//! the same canonical data shapes as unit tests.
...
/// Creates `count` sequential scheduled streams.
