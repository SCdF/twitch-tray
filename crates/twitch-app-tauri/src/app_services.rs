// Re-export AppServices trait and DebugStreamEntry from backend.
// The mock submodule lives here so commands.rs tests can access it,
// since cfg(test) code is not exported across crate boundaries.
pub use twitch_backend::app_services::{AppServices, DebugStreamEntry};
